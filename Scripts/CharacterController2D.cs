...
namespace Prime31 {
	...
	public class CharacterController2D : MonoBehaviour
	{
		...
		public void recalculateDistanceBetweenRays()
		{
			...
			// horizontal
			var colliderUseableHeight = boxCollider.bounds.size.y * Mathf.Abs( transform.localScale.y ) - ( 2f * _skinWidth );
			_verticalDistanceBetweenRays = colliderUseableHeight / ( totalHorizontalRays - 1 );

			// vertical
			var colliderUseableWidth = boxCollider.bounds.size.x * Mathf.Abs( transform.localScale.x ) - ( 2f * _skinWidth );
